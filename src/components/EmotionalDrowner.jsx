...
export default function EmotionalDrowner() {
  return (
    <div className="max-w-2xl mx-auto text-center space-y-6 p-8">
      <h1 className="text-4xl text-[#F97316]">You’re an Emotional Drowner</h1>
      <p className="text-lg text-gray-300">
        You confuse emotional honesty with transformation. 
        You feel deeply — but healing requires facing patterns, not just feeling pain.
      </p>
      <a 
        href="https://yourdomain.com/toolkit-drowner.pdf" 
