...
export default function Quiz() {
  ...
  if (step === -1) {
    return (
      <div className="max-w-2xl mx-auto text-center px-6 py-16 space-y-10 text-white">
        <h1 className="text-5xl font-extrabold text-[#F97316] leading-tight">What’s Secretly Sabotaging Your Self-Work?</h1>
        <p className="text-lg text-gray-300 leading-relaxed">
          You *know* the language of healing — shadow work, boundaries, journaling. But something keeps short-circuiting your progress.
        </p>
        <p className="text-sm text-gray-400 italic">This isn’t a vibe check. It’s a clarity mirror. You’ll walk away knowing your primary growth trap — and how to finally move through it.</p>
        <button
          onClick={() => setStep(0)}
          className="bg-[#F97316] text-black text-lg font-semibold px-6 py-4 rounded-full hover:bg-[#ea580c] shadow-md transition"
        >
          Let’s Get Started ↓
        </button>
      </div>
